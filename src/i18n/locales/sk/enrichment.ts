...
const enrichment = {
  ...
  empty: {
    ...
    allArchivedHelp:
      "Otvorte archivované aktivity nižšie a obnovte jednu z nich, aby ste mohli zaznamenať hru.",
    none: "Zatiaľ žiadne aktivity.",
    noneHelp: "Pridajte aktivitu a začnite zaznamenávať hru.",
  },
  errors: {
    activityArchived:
    ...
    logFailed: "Hru sa nepodarilo zaznamenať. Skúste to znova.",
    ...
    saveFailed: "Hru sa nepodarilo uložiť. Poznámka aj čas zostali zachované.",
  },
  fields: {
    activity: "Aktivita",

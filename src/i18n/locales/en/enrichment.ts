const enrichment = {
  ...
  empty: {
    ...
    allArchivedHelp:
      "Open the archived activities below and restore one to log enrichment.",
    none: "No activities yet.",
    noneHelp: "Add an activity to start logging enrichment.",
  },
  errors: {
    activityArchived:
    ...
    logFailed: "We couldn't log that enrichment activity. Try again.",
    ...
    saveFailed:
      "We couldn't save this enrichment activity. Your note and time are still here.",
  },
  fields: {
    activity: "Activity",
    ...
    note: "Activity note",
    optional: "(optional)",
    startedAt: "When did the activity start?",
    timezone: "Timezone: {{timezone}}",
  },
  forms: {
    create: "Create custom activity",
    createTitle: "Add an activity",
    log: "Log another activity",
    logTitle: "Log a past activity",
    noteCount: "{{count}}/500 characters",
  },
  intro: {
    body: "Keep {{name}} curious with new places, challenges, and activities. Log them here.",
    title: "Enrichment",
  },
